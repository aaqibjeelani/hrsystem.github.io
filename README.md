...
**Download & Preview on [AJvirus](http://aaqibjeelani.ddns.net)**

Looking for Premium Templates?
------------------------------
**AJvirus studio just opened a new premium templates page. Hand picked to insure the best quality and the most affordable prices. Visit http://aaqibjeelani.ddns.net for more information.**
...
Download from Github or [visit AJvirus](http://aaqibjeelani.ddns.net) and download the latest release.
...
```
composer require "ajvirus/adminlte=~2.0"
```

Documentation
-------------
Visit the [online documentation](https://aaqibjeelani.github.io/ajvirus) for the most
...
- When you contribute, you agree to give a non-exclusive license to AJvirus to use that contribution in any context as we (AJvirus) see appropriate.
...
License
-------
AdminLTE is an open source project by [AJvirus](http://aaqibjeelani.ddns.net) that is licensed under [MIT](http://opensource.org/licenses/MIT). AJ virus
...
Legacy Realeases
----------------
AdminLTE 1.x can be easily upgraded to 2.x using [this guide](http://aaqibjeelani.github.io/ajvirus), but if you intend to keep using AdminLTE 1.x, you can download the latest release from the [releases](http://aaqibjeelani.github.io/ajvirus) section above.
